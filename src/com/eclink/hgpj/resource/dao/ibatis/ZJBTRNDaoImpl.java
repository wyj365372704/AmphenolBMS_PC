 ...
 *
 */
public class ZJBTRNDaoImpl extends SqlMapClientDaoSupport implements ZJBTRNDao {

	@Override
	public void insertZjbtrn(ZJBTRNVO vo) throws Exception {
		getSqlMapClientTemplate().insert("ZJBTRN.insertZjbtrn", vo);	
	}

	@Override
	public List<ZJBTRNVO> queryZjbtrnByMap(Map map) throws Exception{
		return getSqlMapClientTemplate().queryForList("ZJBTRN.queryZjbtrnByMap", map);
	}

	@Override
	public List<ZJBTRNVO> queryZjbtrnByJtdnoLike(String s) throws Exception {
		return getSqlMapClientTemplate().queryForList("ZJBTRN.queryZjbtrnByJtdnoLike", s);
	}

	@Override
	public void updateZjbtrn(ZJBTRNVO vo) throws Exception{
		getSqlMapClientTemplate().insert("ZJBTRN.updateZjbtrn", vo);	
	}
}
