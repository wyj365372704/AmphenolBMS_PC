 ...
 *
 */
public class ZITMEXTDaoImpl extends SqlMapClientDaoSupport implements ZITMEXTDao {

	@Override
	public List<ZITMEXTVO> queryItemExt(ZITMEXTVO vo) throws Exception {
		return this.getSqlMapClientTemplate().queryForList("ZITMEXT.queryItemExt", vo);
	}
