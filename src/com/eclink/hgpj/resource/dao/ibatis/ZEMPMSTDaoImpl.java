 ...
 *
 */
public class ZEMPMSTDaoImpl extends SqlMapClientDaoSupport implements ZEMPMSTDao {

	@Override
	public List<ZEMPMSTVO> queryZempmstByMap(Map map) throws Exception {
		return this.getSqlMapClientTemplate().queryForList("ZEMPMST.queryZempmstByMap",map);
	}
	@Override
	public List<ZEMPMSTVO> queryZempmstByMapWithDept(Map map) throws Exception {
		return this.getSqlMapClientTemplate().queryForList("ZEMPMST.queryZempmstByMapWithDept",map);
	}
