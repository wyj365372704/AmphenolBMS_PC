 ...
 *
 */
public class ZMBD1REPDaoImpl extends SqlMapClientDaoSupport implements ZMBD1REPDao {

	@Override
	public List<ZMBD1REPVO> queryZmbd1erp(ZMBD1REPVO vo) throws Exception {
		return this.getSqlMapClientTemplate().queryForList("ZMBD1REP.queryZmbd1erp",vo);
	}
