 ...
 *
 */
public class ZDEPTDaoImpl extends SqlMapClientDaoSupport implements ZDEPTDao {

	@Override
	public List<ZDEPTVO> queryZdeptByMap(Map map) throws Exception {
		return this.getSqlMapClientTemplate().queryForList("ZDEPT.queryZdeptByMap",map);
	}
