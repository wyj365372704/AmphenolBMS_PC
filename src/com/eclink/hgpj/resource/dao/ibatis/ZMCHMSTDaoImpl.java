 ...
 *
 */
public class ZMCHMSTDaoImpl extends SqlMapClientDaoSupport implements ZMCHMSTDao {
	@Override
	public List<ZMCHMSTVO> queryZmchmstByMapWithDept(Map map) throws Exception {
		return this.getSqlMapClientTemplate().queryForList("ZMCHMST.queryZmchmstByMapWithDept",map);
	}
}
