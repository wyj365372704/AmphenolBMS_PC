...
<s:form action="listOfficer.action" method="post" name="queryform" >


    <div class="path">您现在的位置： 首页 &gt; 统计查询 &gt; 关员评价统计</div>
    ...
    <div class="search">
        ...
        <ul>
            ...
            <li><div class="w_s">用户名：</div>
            <s:textfield  id="userName" name="map.userName" cssClass="input_w"/>
            </li>
