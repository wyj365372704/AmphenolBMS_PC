				...
				<td>
					<table width="100%">
						<tbody>
							...
							<tr>
								<td align="center" width="100%">
									<span style="font-weight: bold;font-size:18px;">采购入库单</span>
								</td>
								<td align="right" nowrap="nowrap">打印日期:</td>
							</tr>
						</tbody>
					</table>
				</td>
					...
					<table width="100%" cellpadding="3px">
						<tbody>
							...
							<tr>
								...
								<td colspan="2">物料描述: <s:property value="blcf"/></td>
							</tr>
							<tr>
								<td>默认子库: </td>
								<td colspan="2">默认库位: </td>
							</tr>
						</tbody>
					</table>
				</td>
						...
						<tbody>
							...
							<s:if test="blcf == 1">
					      		<s:iterator value="#rs.itemList" id="it" status="st">
									<tr>
						      			<td align="center"><s:property value="lbhno"/></td>
										<td align="center"><s:property value="gbqty"/></td>
										<td align="center"><s:property value="#rs.grwgt1"/>G</td>
										<td align="center"><s:property value="gbqty*#rs.grwgt1"/> KG</td>	
									</tr>		
					      		</s:iterator>
					      	</s:if>
					      	<s:else>
								<tr>			      		
									<td align="center"></td>
									<td align="center"><s:property value="grqty"/></td>
									<td align="center"><s:property value="grwgt1"/>G</td>
									<td align="center"><s:property value="grqty*grwgt1"/> KG</td>
								</tr>
					      	</s:else>
						</tbody>
					</table>
