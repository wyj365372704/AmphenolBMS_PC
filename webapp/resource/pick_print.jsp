		...
		<div class="public_div">
			...
			<div class="public_inner">
				<table width="100%" border="0" cellspacing="1" cellpadding="0"
					...
					<tbody>
						<tr>
							<td class="td_w_s text_r">打印领料单：</td>
							<td>
								<input type="checkbox" name="input1" value="" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td class="td_w_s text_r">打印分装标签：</td>						
							<td>
								<input type="checkbox" name="input1" value="" />
							</td>
						</tr>
						<tr>
							...
							<td align="center">
								<s:submit id="queryId" value="打印" onclick="return dosubmit()"></s:submit>
							</td>
						</tr>
					</tbody>
				</table>
