...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
	<s:form action="resource!insert.action" method="post">
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0"
					...
					<tr>
						...
						<td>
							...
							<input type="hidden" name="menu.parentMenu" value="<s:property value='menu.menuId'/>" />
						</td>
					</tr>
					<tr>
						<td class="td_w_s text_r">菜单名称：</td>
						<td>
							<input type="text" name="menu.menuName" class="input_s_1" maxlength="10" reg="^\S+$" tip="菜单名称为必填项"/>
							<span class="red">*</span>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" name="menu.menuKey" class="input_s_1" maxlength="80" reg="^[A-Z]+[A-Z_]*$" tip="菜单KEY为必填项，只能包含大写英文字母与下划线，且只能以大写英文字母开头"/>
							<span class="red">*</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							...
							<s:else>
								<input type="text" name="menu.menuUrl" class="input_s_1" maxlength="128" reg="^\S+$" tip="菜单入口访问地址为必填项"/>
								<span class="red">*</span>
							</s:else>
						</td>
					</tr>
