...
<script type="text/javascript">
	...
	function goconfirm(idx,ipdno) {
	document.getElementsByName("ipdno")[idx].checked = "true";
		if (confirm("确定对该单据进行审核操作吗？")) {
			...
			<div>
				<table width="100%" border="0" cellspacing="1" cellpadding="0"
					...
					<s:iterator value="results" id="results" status="st">
						...
						<td><input name="ipdno" type="radio"
							value="<s:property value="ipdno"/>" />
						<s:property value="ipdno" />
						</td>
					...
					<td><s:property value="cmmt" /></td>
						...
						<td><input type="button" id="confirmbtn" value="审批"
							class="gray_button"
							onclick="goconfirm('<s:property value="#st.index"/>','<s:property value="ipdno"/>');" /></td>
