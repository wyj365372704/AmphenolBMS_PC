...
<s:form action="pomast!toPomast.action" method="post" name="queryform">
	...
	<div class="path">您现在的位置： 首页 &gt; 生产 &gt; 采购订单</div>
		...
		<ul>
			...
			<s:select name="pomast.fitwh" list="#session.houses" listKey="house" listValue="house"   cssClass="select_s_2" style="width:60px"></s:select>
			</li>
			
			<li><div class="w_s">供应商名称：</div>
				<s:textfield name="pomast.vn35" cssClass="input_w"/>
			</li>
			<li><div class="w_s">采购员：</div>
				<s:textfield name="pomast.buyno" cssClass="input_w"/>
			</li>
			 <li><div class="w_s">创建日期：</div>
            <s:textfield  id="startDate" name="pomast.startDate" cssClass="time_input" onclick="WdatePicker()" autocomplete="on"/>-
            <s:textfield  id="endDate" name="pomast.endDate" cssClass="time_input" onclick="WdatePicker()" autocomplete="on"/>
            </li>
            
            <li><div class="w_s">订单：</div>
				<s:textarea  name="pomast.ordno" cssClass="input_w" style="height:30px" ></s:textarea>
			</li>
			<li>
	...
	<div class="data_list">
		...
		<div class="list_inner">
			<table width="100%" border="0" cellspacing="1" cellpadding="0" class="list_table_s">
			  <tr>
				<th><input name="chkall" type="checkbox" onclick="selectall();"/> 单号</th>
				<th>仓库</th>
				<th>供应商</th>
				<th>币种</th>
				<th>采购员</th>
			...
			<s:iterator value="results" id="results" status="st">
		      	...
		      	<s:else>
	  				...
	  				<td><input name="chk" type="checkbox" value="<s:property value="ordno"/>"/><s:property value="ordno"/></td>
	  				...
	  				<s:elseif test="pstts==20">
	  					供应商已接受
	  				</s:elseif>
	  				<s:elseif test="pstts==30">
	  					部分收货
	  				</s:elseif>
	  				<s:elseif test="pstts==35">
	  					发票完成
	  				</s:elseif>
	  				<s:elseif test="pstts==40">
	  					收货完成
	  				</s:elseif>
	  				<s:elseif test="pstts==50">
	  					发票、收货都完成
	  				</s:elseif>
	  				<s:elseif test="pstts==50">
	  					已取消
	  				...
	  				<td>
	  				<s:if test='pstts=="10"||pstts=="20"||pstts=="30"||pstts=="40"||pstts=="35"'>
	  					<input type="button" id="printO" value="打印" class="gray_button" onclick="printOdr('<s:property value="ordno"/>');"/>
	  				</s:if>
	  				</td>
