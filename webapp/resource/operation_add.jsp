...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
	<s:form action="/operation/operation!insert.action" method="post" onsubmit="return doSubmit()">
			...
			<div class="public_inner">
				<table width="100%" border="0" cellspacing="1" cellpadding="0"
					...
					<tr>
						...
						<td>
							<input type="text" name="oper.operKey" class="input_s_1" maxlength="80" reg="^[A-Z]+[A-Z_]*$" tip="操作KEY为必填项，只能包含大写英文字母与下划线，且只能以大写英文字母开头"/>
							<span class="red">*</span>
						</td>
					</tr>
					<tr>
