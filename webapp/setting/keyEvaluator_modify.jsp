...
<s:form action="keyEvaluator!modify.action" method="post" name="myform" >
	<div class="path">您现在的位置： 首页 &gt; 系统设置 &gt; 按键式评价器设置&gt; 修改按键式评价器设置</div>
	<div class="public_div">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" class="public_table">
				...
				<td width="37%">
					<s:hidden name="keyEvaluator.id"></s:hidden>
